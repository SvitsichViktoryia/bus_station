			...
			<div class="container">
				<c:if test = "${empty tickets}">
					<div class="alert alert-info">
						На данный момент у вас отсутствуют заказанные билеты!
					</div>
				</c:if>
				<c:forEach var="ticket" items="${tickets}">
					<ul class="list-group">
						<li class="list-group-item">
							<div class="row">
								<div class="col-md-9">
									<strong>Маршрут: </strong><c:out value="${ticket.route.destination.name}"/> - <c:out value="${ticket.route.departure.name}"/>
